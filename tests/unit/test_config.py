...
class TestParScaleBaseConfig:
    ...
    def test_standard_qwen2_mode(self):
        ...
        with pytest.raises(ValueError, match="Prefix tokens should be 0 when parscale_n=1"):
...
class TestParScaleCrossAttnConfig:
    ...
    def test_cross_attn_validation(self):
        ...
        with pytest.raises(ValueError, match="parscale_cross_attn_layers is specified but enable_cross_attn=False"):
