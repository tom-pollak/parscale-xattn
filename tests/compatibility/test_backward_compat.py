...
class TestAPICompatibility:
    ...
    def test_forward_signature_compatibility(self):
        ...
        config = Qwen2ParScaleConfig(hidden_size=64, num_hidden_layers=1, vocab_size=100)
        model = Qwen2ParScaleForCausalLM(config)
...
class TestParScaleModeCompatibility:
    ...
    def test_parscale_mode_initialization(self):
        ...
        parscale_params = [name for name, _ in model.named_parameters() 
    ...
    def test_cache_compatibility(self):
        ...
        output2 = model(new_tokens, past_key_values=output1.past_key_values, use_cache=True)
